...
状态：F6-1A～H、F6-1I-A/R1、I-B-R1/R2、I-C-A 已完成；F6-1I-C 首次正式执行为 `ROLLBACK_VERIFICATION_FAILED` 且现场冻结；F6-1I-C-R1 已准备等待审查；F6-1I-C-R2 只读事故诊断未开始；正式恢复或收口未授权。当前唯一动作是等待 ChatGPT 审查并授权只读事故诊断。
...
下一阶段建议：等待 ChatGPT 审查 F6-1I-C-R1，并决定是否明确授权 F6-1I-C-R2 只读事故诊断。当前事故现场保持冻结；不得手工恢复、重新执行正式切换、启动服务或自动进入后续恢复/收口。
