...
// ============================================================
// 夹具 11：二维矩阵（heatmap gate 已翻 B-7D）
// ============================================================

test('fixture 11: categorical_matrix → heatmap allowed_explicit, defaultPlan=null', () => {
  const r = run({
  ...
  // heatmap gate 已翻 → allowed_explicit（maxSuitability 限制，auto 无 recommended）
