...
RUN_DIRECTORY = Path(r"E:\3\_training_backups\f6-2c-o4-r3-20260722-165401")
VALIDATION_WORKTREE = Path(
    r"E:\3\_validation_worktrees\f6-2c-o4-r3-20260722-165401"
)
RAW_SSE_DIRECTORY = RUN_DIRECTORY / "raw_sse"
EVIDENCE_DIRECTORY = RUN_DIRECTORY / "evidence"
EXPECTED_QUESTION_SHA256 = (
    "c198afde8fa966bbe913b904328508dcf99162a7ef4765f0b8fec8f6ecd6e460"
)
QUESTION = (
    "\u67e5\u8be2\u5e74\u5ea6pH\u5e74\u5747\u503c"
    "\u6700\u9ad8\u7684\u7ad9\u70b9\u5217\u8868"
...
def main() -> int:
    ...
    assert question_sha256 == EXPECTED_QUESTION_SHA256
    ...
    def audited_urlopen(request: Any, *args: Any, **kwargs: Any) -> Any:
        ...
        assert message_sha256 == EXPECTED_QUESTION_SHA256
    ...
    try:
        ...
        write_json(
            EVIDENCE_DIRECTORY / "request-count.json",
            {
                "user_question_request_count": outbound_call_count,
                "http_retry_count": 0,
